...
int main(int argc, char *argv[]) {
    ...
    */
    ...
    int copy_slc[MAX_SIZE];
    array_copy(copy_slc, array, length);

    reset_comparisons_counter();
    reset_swaps_counter();
    set_current_time();

    insertion_sort(copy_slc, length);
    ...
    */
    ...
    int copy_quick[MAX_SIZE];
    array_copy(copy_quick, array, length);

    reset_comparisons_counter();
    reset_swaps_counter();
    set_current_time();

    quick_sort(copy_quick, length);
